...
class CategoryControllerTest extends WebTestCase
{
    ...
    private string $path = '/back/category/';
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'category[eats]' => 'Testing',
        ]);

        self::assertResponseRedirects('/back/category/');
    ...
    public function testEdit(): void
    {
        ...
        self::assertSame('Something New', $fixture[0]->getEats());
    }
